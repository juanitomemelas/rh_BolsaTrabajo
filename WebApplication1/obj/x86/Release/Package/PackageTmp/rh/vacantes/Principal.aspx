       ...
       <div class="Contactos">
            <asp:GridView ID="GridView1" runat="server" 
                DataKeyNames="ID" DataSourceID="SqlDataSource1" 
                 PageSize="25" AutoGenerateColumns="False" cssclass="search-table tablesorter"
                ...
                <Columns >      
                   ...
                   <asp:TemplateField HeaderText="Perfil" SortExpression="DESCRIPCION">
                        <ItemTemplate>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ...
                SelectCommand="
 SELECT RH_VACANTES.ID, RH_VACANTES.PUESTO, RH_VACANTES.DESCRIPCION,RH_VACANTES.COMPETENCIAS, RH_LOCACIONES.LOCACION as UBICACION, RH_TIPOCONTRATO.CONTRATO as TIPO_CONTRATO, RH_VACANTES.RANGO_EDAD, RH_VACANTES.SEXO, RH_VACANTES.STATUS 
 FROM RH_VACANTES
...
WHERE (RH_VACANTES.STATUS = 'V') order by RH_VACANTES.ID" 
                ...
                UpdateCommand="UPDATE &quot;RH_VACANTES&quot; SET &quot;PUESTO&quot; = ?, &quot;DESCRIPCION&quot; = ?, &quot;UBICACION&quot; = ?, &quot;TIPO_CONTRATO&quot; = ?, &quot;RANGO_EDAD&quot; = ?, &quot;IDIOMA&quot; = ?, &quot;SEXO&quot; = ?, &quot;STATUS&quot; = ? WHERE &quot;ID&quot; = ? AND ((&quot;PUESTO&quot; = ?) OR (&quot;PUESTO&quot; IS NULL AND ? IS NULL)) AND ((&quot;DESCRIPCION&quot; = ?) OR (&quot;DESCRIPCION&quot; IS NULL AND ? IS NULL)) AND ((&quot;UBICACION&quot; = ?) OR (&quot;UBICACION&quot; IS NULL AND ? IS NULL)) AND ((&quot;TIPO_CONTRATO&quot; = ?) OR (&quot;TIPO_CONTRATO&quot; IS NULL AND ? IS NULL)) AND ((&quot;RANGO_EDAD&quot; = ?) OR (&quot;RANGO_EDAD&quot; IS NULL AND ? IS NULL)) AND ((&quot;IDIOMA&quot; = ?) OR (&quot;IDIOMA&quot; IS NULL AND ? IS NULL)) AND ((&quot;SEXO&quot; = ?) OR (&quot;SEXO&quot; IS NULL AND ? IS NULL)) AND &quot;STATUS&quot; = ?" >
                <DeleteParameters>
                    ...
                    <asp:Parameter Name="original_UBICACION" Type="String" />
                    <asp:Parameter Name="original_TIPO_CONTRATO" Type="String" />
                    <asp:Parameter Name="original_TIPO_CONTRATO" Type="String" />
                    <asp:Parameter Name="original_RANGO_EDAD" Type="String" />
                    <asp:Parameter Name="original_RANGO_EDAD" Type="String" />
                ...
                <InsertParameters>
                    ...
                    <asp:Parameter Name="RANGO_EDAD" Type="String" />
